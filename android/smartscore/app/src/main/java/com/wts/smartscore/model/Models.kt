...
enum class ScanState { SEARCHING, DOCUMENT_FOUND, ALIGN, MOVE_CLOSER, HOLD_STEADY, CAPTURING, SCANNED, WAITING_FOR_PAGE_EXIT }
...
data class SheetSide(val sheetId:String,val sideId:String,val sideNumber:Int,val totalSides:Int,val rowStart:Int,val rowEnd:Int,val templateVersion:String,val rows:List<StudentRow>)
