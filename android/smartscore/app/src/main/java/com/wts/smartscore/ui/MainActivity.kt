...
class MainActivity:AppCompatActivity(){
 ...
 private fun showHome(){val root=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;setPadding(28,42,28,28);setBackgroundColor(0xFFF4F7FA.toInt())};root.addView(TextView(this).apply{text="WTS SMARTSCORE";textSize=28f;setTextColor(0xFF17324D.toInt())});root.addView(TextView(this).apply{text="Private scanning & marking workspace";textSize=14f;setPadding(0,0,0,24)});root.addView(card("SMART BROADSHEET","Scan, recognize and review handwritten class scores"){startActivity(Intent(this,BroadsheetScannerActivity::class.java))});root.addView(card("SCRIPT SCANNER","Automatically digitize a complete student answer script"){startActivity(Intent(this,ScriptScannerActivity::class.java))});root.addView(card("AI MARKER","Prepare a saved script for AI-assisted marking"){startActivity(Intent(this,AiMarkerActivity::class.java))});root.addView(card("GENERAL DOCUMENT SCANNER","Automatically scan ordinary multipage documents"){startActivity(Intent(this,GeneralScannerActivity::class.java))});root.addView(card("SAVED BROADSHEETS","Open locally saved score batches"){startActivity(Intent(this,SavedBroadsheetsActivity::class.java))});root.addView(card("SAVED SCRIPTS","Open locally saved script packages"){startActivity(Intent(this,SavedScriptsActivity::class.java))});setContentView(ScrollView(this).apply{addView(root)})}
