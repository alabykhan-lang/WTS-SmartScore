...
- `python3 test-artifacts/generate_broadsheet_ocr_diagnostics.py` passes 32 deterministic known-value/state cases and produces a visually aligned SMB-TEST-0001 template overlay plus labelled source/preprocessed ROI samples. This is a structural test, not an Android handwriting-model accuracy benchmark.
